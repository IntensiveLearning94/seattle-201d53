...
function multiply(a, b) { //eslint-disable-line
  ...
  function sumArray(sumArr) { //eslint-disable-line
    ...
    var arrayAnsw = (sumArr + ' was passsed in as an array of numbers, and ' + arraySum + 'is their sum.')


    return [sumArr, arraySum]
  ...
  function multiplyArray(multArr) { //eslint-disable-line
    var proArray = multiply(multArr[0], multArr[1])[0];
    proArray = multiply(proArray, multArr[2])[0];

    var answer = ('The numbers ' + multiplyArray + ' have a prodcut of' + proArray + '.');
